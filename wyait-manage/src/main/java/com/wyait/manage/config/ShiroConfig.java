...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(
		...
		filterChainDefinitionMap.put("/images/**", "anon");
		filterChainDefinitionMap.put("/images/xxx.png", "anon");
		...
		filterChainDefinitionMap.put("/sychronization/*", "anon");  //PC端

		filterChainDefinitionMap.put("/fieldsettings/*", "anon");  //参数
