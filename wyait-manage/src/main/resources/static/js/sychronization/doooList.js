    ...
    layui.use('table', function(){
        ...
        tableIns=table.render({
            ...
            ,cols: [[
                ...
                ,{field: 'username', title: '事项名称'}
                ,{field: 'sex', title: '事项编码'}
                ,{field: 'city', title: '受理标准'}
                ,{field: 'sign', title: '办件类型'}
                ,{field: 'experience', title: '办理时限'}
                ,{field: 'score', title: '空表下载'}
                ,{field: 'classify', title: '示例样本'}
                ,{field: 'wealth', title: '审批信息'}
                ,{field: 'sda', title: '操作',width:240,align:'center', toolbar:'#optBar'}
            ]]
