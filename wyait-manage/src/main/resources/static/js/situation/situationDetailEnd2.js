...
$(function() {
    layui.use('table', function(){
        ...
        form.on('submit(userSubmit2)', function(data){
            ...
            $.ajax({
                url: '/data/setDataAndSituation',
                data:{'dataId':$("#dataSelect").val(),'situationDetailsId':$("#situationDetailsId2").val(),'situationId':$("#situationId").val()},
                type: 'post',
...
function submitAjax(obj){
    $.ajax({
        ...
        url: "/situation/getSituationDetails",
        success: function (data) {
            if (data == "ok") {
                layer.alert("操作成功",function(){
                    location.reload();
