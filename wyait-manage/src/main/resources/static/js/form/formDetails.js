...
$(function() {
    layui.use('table', function(){
        ...
        tableIns=table.render({
            elem: '#uesrList'
            ,url:'/form/getFormList?formFieldComboId='+$("#formFieldComboId").val()+"&formMainId="+$("#form_main_id").val()
            ,method: 'get' //默认：get请求
            ,cellMinWidth: 80
            ,page: true,
            request: {
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                // put(data);
                //跳转子情形页面
                window.location.href='/form/nextForm?comboId='+$("#formFieldComboId").val()+'&formId='+data.formFieldId
            }
