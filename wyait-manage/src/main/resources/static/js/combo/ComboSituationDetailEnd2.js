...
$(function() {
    layui.use('table', function(){
        ...
        form.on('submit(userSubmit2)', function(data){
            // TODO 校验
            // formSubmit(data);
            console.log(data.field.dataId);
            var id = data.field.situationDetailsId;
            $.ajax({
                url: '/combo/setDataAndComboSituation',
                data:{'dataId':data.field.dataId,'comboSituationId':$("#situationId99").val(),'comboSituationDetailsId':data.field.situationDetailsId},
                type: 'post',
