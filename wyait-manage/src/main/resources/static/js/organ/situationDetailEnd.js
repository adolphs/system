...
$(function() {
    layui.use('table', function(){
        ...
        form.on('submit(userSubmit2)', function(data){
            ...
            var materialsId = data.field.dataId;
            $.ajax({
                url: '/serviceSituation/addMaterialsAndSituationDetails',
                data:{'situationDetailsId':situationDetailsId,'materialsId':materialsId},
                type: 'post',
...
function submitAjax(obj){
    $.ajax({
        ...
        url: "/serviceSituation/addSituationDetails",
        success: function (data) {
            if (data.code == 200) {
