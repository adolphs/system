    ...
    layui.use('table', function(){
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                // 查看
                window.location.href='/serviceItem/serviceItemDetails?carryOutCode='+data.carry_out_code;
...
function submitAjax(obj){
    $.ajax({
        type: "POST",
        data: {'carryOutCode':obj.field.carry_out_code},
        url: "/serviceItem/synchronizeItem",
...
function openUser3(data){
    $("#doooId3").val(data.carry_out_code);
    $("#approval_type").val("");
    layer.open({
        type:1,
        title: '驳回审核',
