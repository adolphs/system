...
$(function() {
    layui.use('table', function(){
        ...
        tableIns=table.render({
            elem: '#uesrList'
            ,url:'/dooo/getDoooList?approvalType=2'
...
function recoverUser(obj) {
    if (confirm("是否确定通过"+ obj.doooName +"事项？")){
        $.ajax({
            url: '/dooo/putApprovalType',
            data:{'doooId':obj.doooId,'approvalType':3},
            // dataType: 'json',
            type: 'post',
            success: function (data) {
                if (data == "ok"){
...
function put() {
        $.ajax({
            url: '/dooo/putApprovalType',
            data:{'doooId':$("#doooId3").val(),'approvalType':4,'approvalText':$("#approval_type").val()},
            // dataType: 'json',
            type: 'post',
            success: function (data) {
                if (data == "ok"){
