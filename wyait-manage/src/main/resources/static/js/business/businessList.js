...
$(function() {
    layui.use('table', function(){
        ...
        tableIns=table.render({
            ...
            ,cols: [[
                {type:'numbers'}
                ,{field:'businessId', title:'业务流水号'}
                ,{field:'cn', title:'姓名'}
                ,{field:'idcardnumber', title:'身份证号'}
                ,{field:'submit', title: '添加时间',align:'center',unresize: true, sort: true}
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                // console.log(data)
                window.location.href='/business/businessDetails?businessId='+data.businessId;
